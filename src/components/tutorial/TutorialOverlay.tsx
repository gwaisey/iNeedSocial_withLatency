...
const STEPS: TutorialStep[] = [
  {
    ...
    body: "Aplikasi ini mensimulasikan media sosial. Scroll dan berinteraksi selama ±30 menit seperti biasanya.",
  },
  {
    emoji: "📸",
    title: "Postingan",
    body: "Setiap kartu menampilkan foto dari pengguna lain. Scroll ke bawah untuk melihat lebih banyak postingan.",
  ...
  },
  {
    emoji: "❤️",
    title: "Tombol Suka",
    body: "Tap ikon hati untuk menyukai postingan yang kamu sukai.",
  ...
  },
  {
    emoji: "💬",
    title: "Komentar",
    body: "Tap ikon gelembung untuk membuka dan melihat komentar pada postingan.",
    selector: "[aria-label='Buka komentar']",
    side: "above",
  },
  {
    emoji: "🌙",
    title: "Ganti Tema",
    body: "Gunakan tombol ini untuk beralih antara tampilan terang dan gelap.",
  ...
  },
  {
    emoji: "🚀",
    title: "Siap Mulai!",
    body: "Scroll dan berinteraksi sesuka hati. Ketika selesai, tap logo iNeedSocial di bawah feed untuk mencatat waktumu.",
  },
]
...
export function TutorialOverlay({ onDone }: TutorialOverlayProps) {
  ...
  // ── Full-screen welcome / done modal ────────────────────────────────────────
  function FullModal() {
    return (
